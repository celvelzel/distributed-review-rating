#!/usr/bin/env python
"""Minimal TF-IDF + LightGBM Optimization.

Goal: Beat 0.79012 (current best).
Strategy: 50K subsample for fast iteration.
"""
...
def main():
    print("=" * 60)
    print("Minimal TF-IDF + LightGBM Optimization")
    ...
    # Use small subsample for fast iteration
    SUBSAMPLE = 50000
    ...
    configs = [
        # Current best baseline (5K features)
        {"name": "baseline_5k", "tfidf": {"max_features": 5000, "ngram_range": (1, 1), "sublinear_tf": True},
         "lgb": {"n_estimators": 200, "num_leaves": 127, "learning_rate": 0.05, "subsample": 0.8, "colsample_bytree": 0.8}},
        
        # More features (8K)
        {"name": "tfidf_8k", "tfidf": {"max_features": 8000, "ngram_range": (1, 1), "sublinear_tf": True},
         "lgb": {"n_estimators": 200, "num_leaves": 127, "learning_rate": 0.05, "subsample": 0.8, "colsample_bytree": 0.8}},
        
        # Bigrams (8K)
        {"name": "tfidf_8k_bi", "tfidf": {"max_features": 8000, "ngram_range": (1, 2), "sublinear_tf": True},
         "lgb": {"n_estimators": 200, "num_leaves": 127, "learning_rate": 0.05, "subsample": 0.8, "colsample_bytree": 0.8}},
        
        # More leaves (255)
        {"name": "tfidf_8k_255l", "tfidf": {"max_features": 8000, "ngram_range": (1, 1), "sublinear_tf": True},
         "lgb": {"n_estimators": 200, "num_leaves": 255, "learning_rate": 0.05, "subsample": 0.8, "colsample_bytree": 0.8}},
        
        # Stronger regularization
        {"name": "tfidf_8k_reg", "tfidf": {"max_features": 8000, "ngram_range": (1, 1), "sublinear_tf": True},
         "lgb": {"n_estimators": 200, "num_leaves": 127, "learning_rate": 0.05, "subsample": 0.7, "colsample_bytree": 0.7, "reg_alpha": 0.5, "reg_lambda": 0.5}},
        
        # Lower learning rate
        {"name": "tfidf_8k_slow", "tfidf": {"max_features": 8000, "ngram_range": (1, 1), "sublinear_tf": True},
         "lgb": {"n_estimators": 300, "num_leaves": 127, "learning_rate": 0.03, "subsample": 0.8, "colsample_bytree": 0.8}},
    ]
